...
export default function CassetteDrawer({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
      <div className="relative w-full max-w-4xl bg-[#130f0c] text-white rounded-2xl shadow-2xl border border-white/10 overflow-hidden flex flex-col max-h-[88vh]">
        {/* Header */}
        <div className="bg-[#1f1611] px-6 py-4 flex items-center justify-between border-b border-white/10">
          <div className="flex items-center gap-3">
            <Disc3 className="w-5 h-5 text-amber-500 animate-spin [animation-duration:8s]" />
            <div>
          ...
          {SONGS_DATABASE.map((song) => {
            ...
            return (
              <div
                ...
                className={`group p-3.5 rounded-xl border transition-all cursor-pointer flex gap-3.5 items-start ${
                  isPlaying
              ...
              >
                ...
                <div className="relative w-24 h-16 rounded-lg overflow-hidden border border-white/10 flex-shrink-0 bg-black shadow-md group-hover:scale-105 transition-transform">
                  <img
                  ...
                  {isPlaying && (
                    <div className="absolute top-1 right-1 px-1.5 py-0.5 rounded bg-amber-500 text-black text-[8px] font-mono font-bold uppercase">
                      Playing
                    </div>
                  )}
                </div>
